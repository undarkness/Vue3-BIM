import {
  require_pdf
} from "./chunk-R534WAI7.js";
import "./chunk-OURBZO2E.js";
import {
  __commonJS,
  __privateAdd,
  __privateGet,
...
// node_modules/.pnpm/pdfjs-dist@3.8.162/node_modules/pdfjs-dist/web/pdf_viewer.js
var require_pdf_viewer = __commonJS({
  "node_modules/.pnpm/pdfjs-dist@3.8.162/node_modules/pdfjs-dist/web/pdf_viewer.js"(exports, module) {
      ...
      return (
        ...
        (() => {
          ...
          var __webpack_modules__ = [
            ...
            /***/
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              var _closeCapability, _destroyCapability, _docProperties, _eventBus, _externalServices, _pdfDocument, _pdfViewer, _ready, _sandboxBundleSrc, _scripting, _updateFromSandbox, updateFromSandbox_fn, _dispatchPageOpen, dispatchPageOpen_fn, _dispatchPageClose, dispatchPageClose_fn, _initScripting, initScripting_fn, _destroyScripting, destroyScripting_fn;
              Object.defineProperty(exports2, "__esModule", {
                value: true
              });
              ...
              class PDFScriptingManager {
                constructor({
                  ...
                  const gs = __w_pdfjs_require__2(22);
                  __privateGet(this, _externalServices) || __privateSet(this, _externalServices, {
                    createScripting: (options) => {
                      return new gs.GenericScripting(options.sandboxBundleSrc);
                    }
                  });
                  __privateGet(this, _docProperties) || __privateSet(this, _docProperties, (pdfDocument) => {
                    return gs.docProperties(pdfDocument);
                  });
                  if (!externalServices) {
                    window.addEventListener("updatefromsandbox", (event) => {
                      __privateGet(this, _eventBus).dispatch("updatefromsandbox", {
                        source: window,
                        detail: event.detail
                      });
                    });
              ...
              updateFromSandbox_fn = async function(detail) {
                ...
                for (const elementId of ids) {
                  ...
                  if (element) {
                    ...
                    (_a = __privateGet(this, _pdfDocument)) == null ? void 0 : _a.annotationStorage.setValue(elementId, detail);
                  }
                }
              };
              ...
              destroyScripting_fn = async function() {
                ...
                (_b = __privateGet(this, _destroyCapability)) == null ? void 0 : _b.resolve();
              };
